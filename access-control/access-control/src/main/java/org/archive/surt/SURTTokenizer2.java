/* SURTTokenizer
 *
 * $Id: SURTTokenizer.java 4795 2006-12-12 23:42:09Z paul_jack $
 *
 ...
 *
 * @author brad
 * @version $Date: 2006-12-12 15:42:09 -0800 (Tue, 12 Dec 2006) $, $Revision: 4795 $
 */
public class SURTTokenizer2 {

        public final static String EXACT_SUFFIX = "\t";
        ...
        public SURTTokenizer2() {
        }
        
        public void setSURT(String surt) {
            remainder = getKeyFromSURT(surt, false);
        }
         ...
         * @throws URIException 
         */
        public SURTTokenizer2(final String url) throws URIException {
        ...
        throws URIException {
                ...
                key = getKeyFromSURT(key, prefix);
                return key;
        }

        private static String getKeyFromSURT(String surtKey, boolean prefix) {
            int hashPos = surtKey.indexOf('#');
            if(hashPos != -1) {
                    surtKey = surtKey.substring(0,hashPos);
            }
            
            if(surtKey.startsWith("http://")) {
                    surtKey = surtKey.substring(7);
            }
            if(prefix) {
                    if(surtKey.endsWith(")/")) {
                            surtKey = surtKey.substring(0,surtKey.length()-2);
                    }
            }
            return surtKey;
        }
        ...
        /**
         * Create new SURTTokenizer from a SURT rather than a URL.
         */
        public static SURTTokenizer2 newFromSURT(String surt) {
            SURTTokenizer2 tok = new SURTTokenizer2();
            tok.setSURT(surt);
            return tok;
        }
}
