...
/**
 * Dedupes a FieldSplitLine by a specific field, or part of a specific field
 * eg:
 * 
 * <field> = if <field> matches previous match, then its a dupe
 * <field>:<n> = if first <n> character of <field> match, then its a dupe
 * 
 * 
 * @author ilya
 *
 */
public class PrefixFieldDeduper {
	...
	class DupeMatch {
		...
		{			
			String currValue = line.fields[fieldIndex];
	...
	public PrefixFieldDeduper(String[] fields, String[] namesArr)
	{
		if (namesArr != null) {
