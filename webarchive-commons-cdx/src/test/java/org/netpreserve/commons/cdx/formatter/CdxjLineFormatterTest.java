 ...
 */
public class CdxjLineFormatterTest {
    ...
    public void testFormat() throws Exception {
        CdxFormat outputFormat = CdxjLineFormat.DEFAULT_CDXJLINE;
        CdxjLineFormatter instance = new CdxjLineFormatter();
        Writer out;
        String result;
        String expectedJson;
        ...
        result = out.toString();
        expectedJson = "{\"uri\":\"https://www.terra.as/gfx/whitepixel.gif\","
        ...
        assertThat(result).startsWith("(as,terra,)/gfx/whitepixel.gif 2007-08-21T18:35:28Z response");
        assertThatJson(result.substring(result.indexOf("{"))).isEqualTo(expectedJson);

        String cdxjLine = "(as,terra,)/gfx/whitepixel.gif 2007-08-21T18:35:28Z response "
                + "{\"uri\":\"https://www.terra.as/gfx/whitepixel.gif\","
                + "\"mct\":\"image/gif\",\"hsc\":200,"
                + "\"sha\":\"FQ2WDWANAVUTLNKHGLRCOG4HKQWKHLVQ\",\"rle\":396,"
                + "\"ref\":\"warcfile:IAH-20070821182921-00150.arc.gz#36942074\"}";
        ...
        String cdxjson = "{\"uri\":\"https://www.terra.as/gfx/whitepixel.gif\","
                ...
                + "\"sha\":\"FQ2WDWANAVUTLNKHGLRCOG4HKQWKHLVQ\",\"rle\":396,"
                + "\"ref\":\"warcfile:IAH-20070821182921-00150.arc.gz#36942074\","
                + "\"sts\":\"2007-08-21T18:35:28Z\",\"srt\":\"response\"}";
